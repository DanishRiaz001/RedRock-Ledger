...
import {
  ...
  LedgerDrilldownScreen, PeriodSelector, AssistantPanel, OnboardingWizard,
} from "./reports.jsx";
import {
  ...
  if(isDesktop)return(
    <div style={{background:T.bg,minHeight:"100vh",fontFamily:"system-ui,-apple-system,sans-serif",display:"flex",flexDirection:"column",height:"100vh"}}>
      ...
      <div id="main-content-area" style={{flex:1,minWidth:0,padding:"26px 32px",overflowY:"auto",height:"100%"}}>
        ...
        {registrationQueue?(
          <RegisterVoucherQueueScreen fileIds={registrationQueue} inboxFiles={inboxFiles} accounts={accounts} contacts={contacts} addTransaction={addTransactionNotified} renameInboxFileEntry={renameInboxFileEntry} onDone={()=>setRegistrationQueue(null)}/>
        ):ledgerAcc?(
